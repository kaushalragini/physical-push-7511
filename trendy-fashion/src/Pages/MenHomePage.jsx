...
const MenHomePage = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/Banner')
      .then(response => {
        console.log(response.data.Banner.MenBanner1)
        console.log(response.data.Banner.MenBanner1)

        setMb1(response.data.Banner.MenBanner1)
        setB2(response.data.Banner.Banner2)
        setMb2(response.data.Banner.MenBanner2)  
        setMb3(response.data.Banner.MenBanner3)
        setMb4(response.data.Banner.MenBanner4)
        setMb5(response.data.Banner.MenBanner5)
        setMb6(response.data.Banner.MenBanner6)
        setMb7(response.data.Banner.MenBanner7)
        setMb8(response.data.Banner.MenBanner8)
        setMb9(response.data.Banner.MenBanner9)
        setMb10(response.data.Banner.Banner.MenBanner10)
        setMb11(response.data.Banner.MenBanner11)
        setMb12(response.data.Banner.MenBanner12)
        setMb13(response.data.Banner.MenBanner13)
        setMb14(response.data.Banner.MenBanner14)
        setMb15(response.data.Banner.MenBanner15)
