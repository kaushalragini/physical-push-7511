...
const SingleWomenProductPage = (id) => {
    ...
    const productData = useSelector((store) => store.WomenAppReducer);
    ...
    switch (param) {
        default:
            ...
            break;
        case "footwear":
            displayData = productData.womenFootwear;
            break;
        case "accessories":
            displayData = productData.womenAccessories;
            break;
        case "clothing":
    ...
    useEffect(() => {
        console.log("aaaaaaa ", displayData);
        if (displayData.length === 0) {
            callWomenData(param, dispatch);
        }
