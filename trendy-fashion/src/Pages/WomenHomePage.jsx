...
const WomenHomePage = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/Banner')
      .then(response => {
        console.log(response.data.Banner.WomenBanner1)

        setWb1(response.data.Banner.WomenBanner1)
        setB2(response.data.Banner.Banner2)
        setWb3(response.data.Banner.WomenBanner3)
        setWb2(response.data.Banner.WomenBanner2)
        setWb4(response.data.Banner.WomenBanner4)
        setWb5(response.data.Banner.WomenBanner5)
        setWb6(response.data.Banner.WomenBanner6)
        setWb7(response.data.Banner.WomenBanner7)
        setWb8(response.data.Banner.WomenBanner8)
        setWb9(response.data.Banner.WomenBanner9)
        setWb10(response.data.Banner.WomenBanner10)
        setWb11(response.data.Banner.WomenBanner11)
        setWb12(response.data.Banner.WomenBanner12)
        setWb13(response.data.Banner.WomenBanner13)
        setWb14(response.data.Banner.WomenBanner14)
        setWb15(response.data.Banner.WomenBanner15)
        setWb16(response.data.Banner.WomenBanner16)
        setWb17(response.data.Banner.WomenBanner17)
        setWb18(response.data.Banner.WomenBanner18)
